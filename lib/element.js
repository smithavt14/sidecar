/* sidecar — the element anchor: how a review item pins to an element inside an ASSET (an .html file
   ...
   alone (that half arrives with the picker). Node has a string and no DOM, so liveness here is
...
module.exports = { parseRef, validSel, isLive, extract, snippet, stripTags, synthQuote, VALUE };
